  ...
  return (
    <section id="home" className="pt-20 min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-12">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-gray-100 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-medium text-gray-700">{t('heroSubtitle')}</span>
            </div>
            
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-black leading-tight">
                {t('heroTitle')} 
                <span className="block text-elegant-gold">{t('heroTitleAccent')}</span>
                {t('heroTitleEnd')}
              </h1>
      ...
      <div className="text-center pb-12">
        ...
        >
          <span className="text-sm font-medium">{t('viewPortfolio')}</span>
