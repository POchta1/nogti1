        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className={`group relative bg-white border border-gray-100 rounded-3xl p-8 hover:shadow-2xl hover:border-gray-200 transition-all duration-500 ${
              ...
              >
                ...
                <div className={index === 0 ? 'lg:grid lg:grid-cols-2 lg:gap-8' : ''}>
                  ...
                  <div className={index === 0 ? 'lg:flex lg:flex-col lg:justify-between' : ''}>
                    {/* Price and Duration */}
                    ...
                    <button
                      ...
                      className="w-full bg-black text-white py-3 px-6 rounded-full hover:bg-gray-800 transition-colors flex items-center justify-center space-x-2 group/button"
                    >
