...
export const translations = {
  de: {
    ...
    extensionDesc: 'Nagelverlängerung. Größen: S (60€), M (65€), L (70€). Jede Länge und Form mit perfekter Beschichtung.',
    spaCare: 'SPA-Pflege',
  ...
  en: {
    ...
    extensionDesc: 'Nail extensions. Sizes: S (60€), M (65€), L (70€). Any length and shape with perfect coating.',
    spaCare: 'SPA Care',
  ...
  uk: {
    ...
    extensionDesc: 'Нарощування нігтів. Розміри: S (60€), M (65€), L (70€). Будь-яка довжина та форма з ідеальним покриттям.',
    spaCare: 'SPA-догляд',
