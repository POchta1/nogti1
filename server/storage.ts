  ...
  private initializeData() {
    ...
    const services = [
      ...
      },
      {
        id: randomUUID(),
        name: "Наращивание",
        description: "Наращивание ногтей гелем или акрилом. Размеры: S (60€), M (65€), L (70€). Любая длина и форма с идеальным покрытием.",
        price: "60€ - 70€",
        duration: "2.5 часа",
        icon: "gem"
      },
      ...
      },
      {
        ...
        description: "Профессиональное и бережное снятие старого покрытия с ногтей.",
        price: "10€",
        duration: "30 минут",
        icon: "eraser"
      },
